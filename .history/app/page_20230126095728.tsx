...
function LinkCard({
  ...
  const [toggleState, setToggleState] = useState(false);
    ...
    useEffect(()=>{
      const selector = document.querySelector(".linkcard-share");
  ...
  return (
    <div className="home_linkcard-main">
<a
      href={href}
...
export default function Home() {
  ...
  return (
    <div
      className="flex items-center flex-col mx-auto w-full justify-center mt-16 px-8 home-card "
